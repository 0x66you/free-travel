...
def booking_plan3(place,cidate,codate,human,choose,lastname,firstname,email,city,address,phonenum,cardnumber1,cardnumber2,cardnumber3,cardnumber4,ccmonth,ccyear,cvc):
    ...
    time.sleep(5)
    browser.find_elements_by_class_name('bbdb949247')[3].click()
    time.sleep(3)
